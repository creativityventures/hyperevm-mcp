      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "3. Present the options from safest to riskiest: direct staking, liquid staking,",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "2. Call hyperevm_yields to find its pools and what they pay.",
              "3. Compare it to the two closest protocols by TVL in the same category.",
              "",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "3. Report where the annualised rates disagree most between venues.",
              "",
